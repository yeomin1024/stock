# =============================================================================
#  run_pipeline.py
#  VERSION: v1.5.0 - 2026-09-13 - [문서 + 단계별 실행 레시피 — 실행 로직 무변경] S v0.45.0 · I v0.8.0 · M v1.53.0.
...
#    6) **G4′** — 13g '유효표본 n_eff' 열을 볼 것. 2019 REL_DD_252H가 427.7(채택 33행 중 최소, 차순위 802.8)이다.
